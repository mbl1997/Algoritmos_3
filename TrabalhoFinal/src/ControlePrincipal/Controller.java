 ...
 */
package ControlePrincipal;
import EstruturaDeDados.Aresta;
import EstruturaDeDados.Grafos;
import EstruturaDeDados.Vertice;
...
public class Controller {
    ...
    public static void main(String arg[]) {
     ...
     public static void exc(){
		...
		Grafos inicial = new Grafos();
		Grafos resultado = new Grafos();
...
//                        System.out.println("1 - Carrega dados.");
			...
			case 4:
				...
				verticeAux1 = inicial.acharVertice(Key.readString());
                                System.err.println("Vertice 2");
				verticeAux2 = inicial.acharVertice(Key.readString());
			...
			case 5:
				...
				origem = Key.readString();
                                System.err.println("Destino");
				destino = Key.readString();
